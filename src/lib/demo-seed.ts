...
export const INIT_PROJ: Rec[] = [
  {id:"p1",werknummer:"2025-001",projectnaam:"Renovatie Hotel Amsterdam",opdrachtgever:"Hotel Amstel BV",adres:"Professor Tulpplein 1",plaats:"Amsterdam",afdeling:"Stoffering",afdelingen:["Stoffering"],projectleider:"e1",startdatum:mk(-5,8),afloopdatum:mk(12,17),medewerkers:["e2","e8"],status:"In uitvoering",notities:"Klant wil updates elke vrijdag",uurprijs:65,uren:120,region:"West"},
  {id:"p2",werknummer:"2025-002",projectnaam:"Schilderwerk Kantoorpand",opdrachtgever:"ABN AMRO Vastgoed",adres:"Weena 90",plaats:"Rotterdam",afdeling:"Schilderwerk",afdelingen:["Schilderwerk"],projectleider:"e7",startdatum:mk(2,7,30),afloopdatum:mk(9,17),medewerkers:["e3","e4"],status:"Bevestigd",notities:"",uurprijs:55,uren:80,region:"Zuid"},
  {id:"p3",werknummer:"2025-003",projectnaam:"Zonwering Woonhuis",opdrachtgever:"Familie Hendriks",adres:"Maliebaan 45",plaats:"Utrecht",afdeling:"Zonwering",afdelingen:["Zonwering"],projectleider:"e5",startdatum:mk(1,9),afloopdatum:mk(3,16),medewerkers:["e5","e6"],status:"Bevestigd",notities:"Klant aanwezig op maandag",uurprijs:60,uren:24,region:"West"},
  {id:"p4",werknummer:"2025-004",projectnaam:"Gordijnen Appartementencomplex",opdrachtgever:"Woongroep Nederland",adres:"Laan van Meerdervoort 55",plaats:"Den Haag",afdeling:"Stoffering",afdelingen:["Stoffering","Zonwering"],projectleider:"e1",startdatum:mk(14,8),afloopdatum:mk(21,17),medewerkers:["e2"],status:"Offerte",notities:"",uurprijs:65,uren:112,region:"West"},
  {id:"p5",werknummer:"2025-005",projectnaam:"Buitenschilderwerk Villa",opdrachtgever:"Dhr. Van Leeuwen",adres:"Kepplerstraat 12",plaats:"Wassenaar",afdeling:"Schilderwerk",afdelingen:["Schilderwerk"],projectleider:"e7",startdatum:mk(-30,8),afloopdatum:mk(-20,17),medewerkers:["e3"],status:"Afgerond",notities:"",uurprijs:55,uren:48,region:"Noord"},
  {id:"p6",werknummer:"2025-006",projectnaam:"Markiezen Restaurant",opdrachtgever:"Brasserie De Zon",adres:"Grote Markt 7",plaats:"Haarlem",afdeling:"Zonwering",afdelingen:["Zonwering"],projectleider:"e5",startdatum:mk(5,8),afloopdatum:mk(6,16),medewerkers:["e5","e6"],status:"Bevestigd",notities:"Terras open om 11:00",uurprijs:60,uren:16,region:"West"},
];
